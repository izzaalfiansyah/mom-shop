...
!(function (e, t) {
	...
	function _(e) {
		var t = !!e && 'length' in e && e.length,
			n = b(e);
		return (
			!d(e) && !g(e) && ('array' === n || 0 === t || ('number' == typeof t && 0 < t && t - 1 in e))
		);
	}
	(w.fn = w.prototype =
		{
		...
		w.extend({
			...
			isPlainObject: function (e) {
				...
				return !(
					...
					((t = i(e)) &&
						('function' != typeof (n = u.call(t, 'constructor') && t.constructor) ||
							p.call(n) !== h))
				);
			},
			...
			makeArray: function (e, t) {
				var n = t || [];
				return (
					null != e && (_(Object(e)) ? w.merge(n, 'string' == typeof e ? [e] : e) : s.call(n, e)), n
				);
			},
				...
				return (
					s != f &&
						...
						(n.getById = ue(function (e) {
							return (
								(d.appendChild(e).id = x), !f.getElementsByName || !f.getElementsByName(x).length
							);
						})),
						n.getById
										...
										if (((d = [s ? m.firstChild : m.lastChild]), s && v)) {
											...
											(v &&
												(b = f =
													(c =
														(u =
															(p = (h = t)[x] || (h[x] = {}))[h.uniqueID] || (p[h.uniqueID] = {}))[
															e
														] || [])[0] === _ && c[1]),
											!1 === b)
										)
											for (
												...
												((a ? h.nodeName.toLowerCase() !== y : 1 !== h.nodeType) ||
													!++b ||
													(v &&
														((u = (p = h[x] || (h[x] = {}))[h.uniqueID] || (p[h.uniqueID] = {}))[
															e
														] = [_, b]),
													h !== t));
				...
				: function (t, n, l) {
						...
						if (l) {
							...
							for (; (t = t[i]); )
								if (1 === t.nodeType || s)
									if (
										((u = (p = t[x] || (t[x] = {}))[t.uniqueID] || (p[t.uniqueID] = {})),
				...
				if ((n = i.relative[e[l].type])) h = [xe(we(h), n)];
					...
					if ((n = i.filter[e[l].type].apply(null, e[l].matches))[x]) {
						...
						return ke(
							1 < l && we(h),
							1 < l &&
								be(e.slice(0, l - 1).concat({ value: ' ' === e[l - 2].type ? '*' : '' })).replace(
									F,
									'$1',
								),
							n,
				...
				function (e, t, n, o) {
					...
					if (((n = n || []), 1 === f.length)) {
						...
						for (
							...
							if (
								(p = i.find[u]) &&
								(o = p(c.matches[0].replace(te, ne), (ee.test(l[0].type) && ye(t.parentNode)) || t))
							) {
	...
	((w.fn.init = function (e, t, n) {
		...
		if (((n = n || L), 'string' == typeof e)) {
			if (
				!(i =
					'<' === e[0] && '>' === e[e.length - 1] && 3 <= e.length ? [null, e, null] : M.exec(e)) ||
				(!i[1] && t)
			)
			...
			if (!S.test(e))
				for (; i < o; i++)
					for (n = this[i]; n && n !== t; n = n.parentNode)
						if (
							n.nodeType < 11 &&
							(s ? -1 < s.index(n) : 1 === n.nodeType && w.find.matchesSelector(n, e))
						) {
							r.push(n);
							break;
						}
		...
		w.each(
			{
				...
				contents: function (e) {
					return null != e.contentDocument && i(e.contentDocument)
						? e.contentDocument
						: (C(e, 'template') && (e = e.content || e), w.merge([], e.childNodes));
				},
			},
			function (e, t) {
				w.fn[e] = function (n, i) {
					...
					return (
						...
						1 < this.length && (N[e] || w.uniqueSort(o), j.test(e) && o.reverse()),
						this.pushStack(o)
					);
				};
			},
			...
			u = function () {
				for (s = s || e.once, r = i = !0; l.length; c = -1)
					for (o = l.shift(); ++c < a.length; )
						!1 === a[c].apply(o[0], o[1]) && e.stopOnFalse && ((c = a.length), (o = !1));
												...
												(c = e && ('object' == typeof e || 'function' == typeof e) && e.then),
													d(c)
														? o
															...
															: (r++,
															  c.call(e, s(r, n, I, o), s(r, n, H, o), s(r, n, I, n.notifyWith)))
											...
											: function () {
													try {
														...
														w.Deferred.exceptionHook && w.Deferred.exceptionHook(e, u.stackTrace),
															r <= t + 1 &&
																(i !== H && ((a = void 0), (l = [e])), n.rejectWith(a, l));
													}
											  };
									t
										? u()
										: (w.Deferred.getStackHook && (u.stackTrace = w.Deferred.getStackHook()),
										  e.setTimeout(u));
								};
							}
							return w
	...
	(w.fn.ready = function (e) {
		...
		'complete' === m.readyState || ('loading' !== m.readyState && !m.documentElement.doScroll)
			...
			: (m.addEventListener('DOMContentLoaded', z), e.addEventListener('load', z));
			...
			if (
				...
				try {
					n =
						'true' === (o = n) ||
						('false' !== o &&
							('null' === o ? null : o === +o + '' ? +o : G.test(o) ? JSON.parse(o) : o));
				} catch (e) {}
				Q.set(e, t, n);
			} else n = void 0;
		return n;
	...
	function ae(e, t, n, i) {
		...
		if (u && u[3] !== c) {
			for (l /= 2, c = c || u[3], u = +l || 1; s--; )
				w.style(e, t, u + c), (1 - r) * (1 - (r = a() / l || 0.5)) <= 0 && (s = 0), (u /= r);
	...
	function be(e, t, n, i, o) {
		for (
			var r, s, a, l, c, u, p = t.createDocumentFragment(), h = [], f = 0, d = e.length;
			f < d;
			f++
		)
			if ((r = e[f]) || 0 === r)
				...
				for (
					...
					for (
						...
						(l.rnamespace && !1 !== r.namespace && !l.rnamespace.test(r.namespace)) ||
							...
							(l.data = r.data),
							void 0 !==
								(i = ((w.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, a)) &&
								!1 === (l.result = i) &&
	...
	function Ne(e, t, n, i) {
		...
		if (
			...
			for (l = (a = w.map(me(o, 'script'), Le)).length; p < h; p++)
				(c = o),
					p !== g && ((c = w.clone(c, !0, !0)), l && w.merge(a, me(c, 'script'))),
					n.call(e[p], c, p);
			if (l)
					...
					(c = a[p]),
						de.test(c.type || '') &&
							...
							(c.src && 'module' !== (c.type || '').toLowerCase()
								? w._evalUrl &&
								  !c.noModule &&
								  w._evalUrl(c.src, { nonce: c.nonce || c.getAttribute('nonce') }, u)
	...
	function De(e, t, n) {
		for (var i, o = t ? w.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
			n || 1 !== i.nodeType || w.cleanData(me(i)),
				i.parentNode && (n && oe(i) && ye(me(i, 'script')), i.parentNode.removeChild(i));
		return e;
	}
	w.extend({
		...
		clone: function (e, t, n) {
			...
			if (!(f.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || w.isXMLDoc(e)))
				for (s = me(u), i = 0, o = (r = me(e)).length; i < o; i++)
					(a = r[i]),
						'input' === (c = (l = s[i]).nodeName.toLowerCase()) && he.test(a.type)
							? (l.checked = a.checked)
			...
			function (e, t) {
				w.fn[e] = function (e) {
					for (var n, i = [], o = w(e), r = o.length - 1, a = 0; a <= r; a++)
						(n = a === r ? this : this.clone(!0)), w(o[a])[t](n), s.apply(i, n.get());
			...
			'margin' === n && (l += w.css(e, n + ne[s], !0, o)),
				i
					? ('content' === n && (l -= w.css(e, 'padding' + ne[s], !0, o)),
					  'margin' !== n && (l -= w.css(e, 'border' + ne[s] + 'Width', !0, o)))
		...
		style: function (e, t, n, i) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				var o,
					...
					l = Ye.test(t),
					c = e.style;
				if ((l || (t = Ue(a)), (s = w.cssHooks[t] || w.cssHooks[a]), void 0 === n))
	...
	function lt(e, t, n) {
		for (
			var i, o = (ct.tweeners[t] || []).concat(ct.tweeners['*']), r = 0, s = o.length;
			r < s;
			r++
		)
	...
	function ct(e, t, n) {
		...
		for (
			...
			if ((i = ct.prefilters[r].call(c, e, u, c.opts)))
				return d(i.stop) && (w._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
		return (
			w.map(u, lt, c),
				...
				if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(f))
					for (i in (p &&
						...
						'none' === (u = w.css(e, 'display')) &&
							(c
								? (u = c)
								: (ce([e], !0), (c = e.style.display || c), (u = w.css(e, 'display')), ce([e]))),
		...
		trigger: function (t, n, i, o) {
			...
			if (
				...
				3 !== i.nodeType &&
					...
					(c = v.indexOf(':') < 0 && 'on' + v),
					((t = t[w.expando] ? t : new w.Event(v, 'object' == typeof t && t)).isTrigger = o
						? 2
						: 3),
					(t.namespace = b.join('.')),
				...
				if (!o && !h.noBubble && !g(i)) {
					for (l = h.delegateType || v, vt.test(l + v) || (s = s.parentNode); s; s = s.parentNode)
						y.push(s), (a = s);
				...
				for (r = 0; (s = y[r++]) && !t.isPropagationStopped(); )
					(f = s),
						...
						(p = (K.get(s, 'events') || Object.create(null))[t.type] && K.get(s, 'handle')) &&
							p.apply(s, n),
						(p = c && s[c]) &&
							p.apply &&
							V(s) &&
	...
	function Ct(e, t, n, i) {
		...
		if (Array.isArray(t))
			w.each(t, function (t, o) {
				n || kt.test(e)
					? i(e, o)
					: Ct(e + '[' + ('object' == typeof o && null != o ? t : '') + ']', o, n, i);
			});
			...
			ajax: function (t, n) {
				...
				var i,
					...
					E = {
						...
						setRequestHeader: function (e, t) {
							return (
								null == c && ((e = _[e.toLowerCase()] = _[e.toLowerCase()] || e), (x[e] = t)), this
							);
						},
				...
				f.hasContent
					...
					: ((h = f.url.slice(o.length)),
					  ...
					  !1 === f.cache &&
							((o = o.replace(Lt, '$1')), (h = (_t.test(o) ? '&' : '?') + '_=' + wt.guid++ + h)),
					  (f.url = o + h)),
				f.ifModified &&
				...
				E.setRequestHeader(
					...
					f.dataTypes[0] && f.accepts[f.dataTypes[0]]
						? f.accepts[f.dataTypes[0]] + ('*' !== f.dataTypes[0] ? ', ' + It + '; q=0.01' : '')
						: f.accepts['*'],
				),
				f.headers))
				...
				function T(t, n, s, l) {
					...
					c ||
						...
						p
							? (f.ifModified &&
									((_ = E.getResponseHeader('Last-Modified')) && (w.lastModified[o] = _),
			...
			if (a || 'jsonp' === t.dataTypes[0])
				return (
					...
					a
						...
						: !1 !== t.jsonp && (t.url += (_t.test(t.url) ? '&' : '?') + t.jsonp + '=' + o),
		...
		(w.parseHTML = function (e, t, n) {
			return 'string' != typeof e
				...
				: ('boolean' == typeof t && ((n = t), (t = !1)),
				  t ||
						(f.createHTMLDocument
							? (((i = (t = m.implementation.createHTMLDocument('')).createElement('base')).href =
									m.location.href),
				  ...
				  (o = A.exec(e))
						? [t.createElement(o[1])]
						: ((o = be([e], t, r)), r && r.length && w(r).remove(), w.merge([], o.childNodes)));
			var i, o, r;
		}),
		...
		w.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, function (e, t) {
			...
			w.fn[e] = function (i) {
				return F(
					...
					function (e, i, o) {
						var r;
						if ((g(e) ? (r = e) : 9 === e.nodeType && (r = e.defaultView), void 0 === o))
							return r ? r[t] : e[i];
	...
	(function (e, t) {
		...
		function h(e, o, s) {
			...
			return (
				(h || (!h && !s)) &&
					(('body' !== a(o) || p(u)) &&
						(f = o !== n(o) && r(o) ? { scrollLeft: o.scrollLeft, scrollTop: o.scrollTop } : i(o)),
					r(o) ? (((d = t(o)).x += o.clientLeft), (d.y += o.clientTop)) : u && (d.x = c(u))),
				{
		...
		function v(e) {
			for (
				var t = n(e), i = y(e);
				i && 0 <= ['table', 'td', 'th'].indexOf(a(i)) && 'static' === u(i).position;
									...
									for (
										...
										if (!0 === a.reset) (a.reset = !1), (t = -1);
											...
											(i = void 0 === i ? {} : i),
												(n = n.name),
												'function' == typeof e &&
													(a = e({ state: a, options: i, name: n, instance: u }) || a);
										}
							}
						},
						update: x(function () {
		...
		var R = ['top', 'bottom', 'right', 'left'],
			...
			J = {
				...
				fn: function (e) {
					var t = e.state,
						...
						o = (e = W.reduce(function (e, n) {
							...
							return (
								(o = (o = a[0]) || 0),
								(a = ((a = a[1]) || 0) * s),
								(r = 0 <= ['left', 'right'].indexOf(r) ? { x: a, y: o } : { x: o, y: a }),
								(e[n] = r),
								e
							);
						}, {}))[t.placement],
					...
					(o = o.y),
						null != t.modifiersData.popperOffsets &&
							((t.modifiersData.popperOffsets.x += r), (t.modifiersData.popperOffsets.y += o)),
						(t.modifiersData[n] = e);
				},
			},
			...
			te = {
				...
				fn: function (e) {
					...
					if (((e = e.name), !t.modifiersData[e]._skip)) {
								...
								'auto' === w(n)
									? (function (e, t) {
											...
											var c = r.reduce(function (t, r) {
												return (
													(t[r] = L(e, { placement: r, boundary: n, rootBoundary: i, padding: o })[
														w(r)
													]),
													t
												);
						...
						t.placement !== g &&
							((t.modifiersData[e]._skip = !0), (t.placement = g), (t.reset = !0));
					}
				},
				...
				fn: function (e) {
					...
					if (((e = S(a)), (a = 0 <= ['left', 'right'].indexOf(a) ? 'height' : 'width'), r && s)) {
						...
						(s = s[e] - n.rects.reference[e]),
							(s =
								(r = (r = v(r)) ? ('y' === e ? r.clientHeight || 0 : r.clientWidth || 0) : 0) / 2 -
								l[a] / 2 +
								(p / 2 - s / 2)),
	...
	(function (e, t) {
							...
							return function i(o) {
								...
								for (let { target: s } = o; s && s !== this; s = s.parentNode)
									for (let a = r.length; a--; )
										if (r[a] === s)
											return (
												(o.delegateTarget = s), i.oneOff && D.off(e, o.type, t, n), n.apply(s, [o])
											);
								return null;
							};
					  })(e, n, i)
		...
		class J extends H {
			...
			_getConfig(e) {
				return (
					(e = { ...X, ...B.getDataAttributes(this._element), ...('object' == typeof e ? e : {}) }),
					s('carousel', e, Y),
					e
				);
			}
			...
			_addEventListeners() {
				this._config.keyboard &&
					...
					'hover' === this._config.pause &&
						(D.on(this._element, 'mouseenter.bs.carousel', (e) => this.pause(e)),
			...
			_getItemIndex(e) {
				return (
					(this._items = e && e.parentNode ? U.find('.carousel-item', e.parentNode) : []),
		...
		class te extends H {
			...
			_getConfig(e) {
				return (
					((e = { ...Z, ...B.getDataAttributes(this._element), ...e }).toggle = Boolean(e.toggle)),
					(e.parent = r(e.parent)),
					s('collapse', e, ee),
					e
				);
		...
		function Ie(e) {
			...
			return a
				...
				: Object.assign(
						{},
						E,
						(((t = {})[v] = m ? d + 'px' : ''), (t[y] = g ? h + 'px' : ''), (t.transform = ''), t),
				  );
		}
		var He = {
				name: 'computeStyles',
									...
									for (var i = 0; i < a.orderedModifiers.length; i++)
										if (!0 !== a.reset) {
											var o = a.orderedModifiers[i],
												...
												p = o.name;
											'function' == typeof r &&
												(a = r({ state: a, options: l, name: p, instance: u }) || a);
										} else (a.reset = !1), (i = -1);
								}
							}
						},
		...
		class kt extends H {
			...
			show() {
				...
				this._inNavbar ? B.setDataAttribute(this._menu, 'popper', 'none') : this._createPopper(t),
					'ontouchstart' in document.documentElement &&
						...
						[].concat(...document.body.children).forEach((e) => D.on(e, 'mouseover', u)),
					this._element.focus(),
			...
			_completeHide(e) {
				D.trigger(this._element, 'hide.bs.dropdown', e).defaultPrevented ||
					('ontouchstart' in document.documentElement &&
						[].concat(...document.body.children).forEach((e) => D.off(e, 'mouseover', u)),
		...
		class Ct {
			...
			_getConfig(e) {
				return (
					((e = { ...Tt, ...('object' == typeof e ? e : {}) }).rootElement = r(e.rootElement)),
					s('backdrop', e, St),
					e
				);
			}
					...
					this._queueCallback(
						() => {
							this._config.scroll || this._focustrap.activate(),
								D.trigger(this._element, 'shown.bs.offcanvas', { relatedTarget: e });
						},
						this._element,
						!0,
					));
		...
		D.on(document, 'click.bs.offcanvas.data-api', '[data-bs-toggle="offcanvas"]', function (e) {
			...
			D.on(window, 'load.bs.offcanvas.data-api', () =>
				U.find('.offcanvas.show').forEach((e) => It.getOrCreateInstance(e).show()),
			),
			R(It),
			g(It);
		const Ht = new Set([
		...
		class Vt extends H {
			...
			show() {
				...
				I.set(i, this.constructor.DATA_KEY, this),
					this._element.ownerDocument.documentElement.contains(this.tip) ||
						(a.append(i), D.trigger(this._element, this.constructor.Event.INSERTED)),
					this._popper
						? this._popper.update()
					...
					return o(t)
						...
						: void (this._config.html
								? (this._config.sanitize &&
										(t = zt(t, this._config.allowList, this._config.sanitizeFn)),
								  (e.innerHTML = t))
								: (e.textContent = t));
			}
			getTitle() {
			...
			_setListeners() {
				this._config.trigger.split(' ').forEach((e) => {
					if ('click' === e)
						D.on(this._element, this.constructor.Event.CLICK, this._config.selector, (e) =>
							this.toggle(e),
						);
					else if ('manual' !== e) {
						const t =
							...
							n =
								'hover' === e ? this.constructor.Event.MOUSELEAVE : this.constructor.Event.FOCUSOUT;
		...
		class nn extends H {
			...
			show() {
				...
				if (
					D.trigger(this._element, 'show.bs.tab', { relatedTarget: e }).defaultPrevented ||
	...
	(function (e, t) {
			...
			(e.containerWidth = n(r.width)),
				...
				e.containerWidth + e.settings.scrollXMarginOffset < e.contentWidth
					? ((e.scrollbarXActive = !0),
					  ...
					  (e.scrollbarXLeft = f(
							((e.negativeScrollAdjustment + i.scrollLeft) * (e.railXWidth - e.scrollbarXWidth)) /
		...
		function m(e, t) {
			var n = Math.min,
				i = Math.max;
			return (
				e.settings.minScrollbarLength && (t = i(t, e.settings.minScrollbarLength)),
		...
		function y(e, n) {
			var o = { width: n.railXWidth },
				r = t(e.scrollTop);
			(o.left = n.isRtl
				? n.negativeScrollAdjustment + e.scrollLeft + n.containerWidth - n.contentWidth
				: e.scrollLeft),
				...
				touch: function (i) {
					function o(n, o) {
						...
						if (l > a) {
							...
							a > l &&
							((0 > n && s === i.contentWidth - i.containerWidth) || (0 < n && 0 === s))
						)
							return !0;
						return !0;
					}
			...
			C = function (e, r) {
				...
				(this.scrollbarXBottom = parseInt(u.bottom, 10)),
					isNaN(this.scrollbarXBottom)
						? ((this.isScrollbarXUsingBottom = !1), (this.scrollbarXTop = f(u.top)))
				...
				(this.scrollbarYRight = parseInt(p.right, 10)),
					isNaN(this.scrollbarYRight)
						? ((this.isScrollbarYUsingRight = !1), (this.scrollbarYLeft = f(p.left)))
			...
			(C.prototype.update = function () {
				this.isAlive &&
					...
					(this.railXMarginWidth =
						f(n(this.scrollbarXRail).marginLeft) + f(n(this.scrollbarXRail).marginRight)),
					(this.railYMarginHeight =
						f(n(this.scrollbarYRail).marginTop) + f(n(this.scrollbarYRail).marginBottom)),
	...
	(function (e, t, n, i) {
		...
		function T(e) {
			for (var t = [], n = 0; n < e.pointers.length; )
				(t[n] = { clientX: ae(e.pointers[n].clientX), clientY: ae(e.pointers[n].clientY) }), n++;
		...
		function I(e, t) {
			...
			for (o = 0; o < s.length; )
				i[s[o].identifier] && a.push(s[o]), t & (we | _e) && delete i[s[o].identifier], o++;
		...
		function R(e, t) {
			e & be
				? ((this.primaryTouch = t.changedPointers[0].identifier), q.call(this, t))
		...
		e.MSPointerEvent &&
			!e.PointerEvent &&
			((Re = 'MSPointerDown'), (qe = 'MSPointerMove MSPointerUp MSPointerCancel')),
			l(j, _, {
				handler: function (e) {
					var t = this.store,
						n = !1,
		...
		(F.prototype = {
			...
			dropRecognizeWith: function (e) {
				return (
					r(e, 'dropRecognizeWith', this) || ((e = X(e, this)), delete this.simultaneous[e.id]),
					this
				);
			},
	...
	(Unison = (function () {
		...
		var e,
			...
			l = {
				all: function () {
					for (
						var e = {}, t = s.parseMQ(n.querySelector('title')).split(','), i = 0;
						i < t.length;
						i++
					) {
		...
		function e(e) {
			...
			function n(t, n) {
				...
				u && (clearTimeout(u), l.removeData('blockUI.timeout')),
					...
					o(0, t, n),
					null === n.onUnblock &&
						((n.onUnblock = l.data('blockUI.onUnblock')), l.removeData('blockUI.onUnblock')),
					(s = a
			...
			function o(t, n, i) {
				...
				if (
					...
					(s.data('blockUI.isBlocked', t), o && i.bindEvents && (!t || i.showOverlay))
				) {
			...
			var l = e.noop || function () {},
				...
				p =
					(document.documentMode, e.isFunction(document.createElement('div').style.setExpression));
	...
	function () {
					...
					for (
						...
						if ((t = o[r]))
							for (e in t)
								$.call(t, e) &&
									((n = t[e]),
									null != i[e] && 'object' == typeof i[e] && null != n && 'object' == typeof n
										? b(i[e], n)
										: (i[e] = n));
					return i;
				},
		...
		function te() {
			...
			te.__super__.constructor.apply(this, arguments),
				(e = function (e) {
					...
					return (e.open = function (i, o, r) {
						return (
							N(i) && t.trigger('request', { type: i, url: o, request: e }), n.apply(e, arguments)
						);
					});
				}),
			...
			if (null != H && C.ajax.trackWebSockets) {
				window.WebSocket = function (e, n) {
					...
					return (
						N('socket') &&
							t.trigger('request', { type: 'socket', url: e, protocols: n, request: i }),
						i
					);
				};
				try {
		...
		K(J, (Y = Error)),
			...
			(ne.prototype.watch = function (e) {
				...
				e = e.url;
				if (!j(e))
					return (n = new ('socket' === t ? u : p)(n, this.complete)), this.elements.push(n);
			}),
			...
			(u = function (e, t) {
				for (
					var n, i = this, o = (this.progress = 0), r = (n = ['error', 'open']).length;
					o < r;
					o++
				)
					h(e, n[o], function () {
			...
			(se.prototype.tick = function (e, t) {
				return (
					...
					t === this.last
						...
						: (this.sinceLastUpdate && (this.rate = (t - this.last) / this.sinceLastUpdate),
			...
			(T = function () {
				var e, t, i, o, r, a, u, p;
				for (
					s.sources = P = [], t = 0, o = (a = ['ajax', 'elements', 'document', 'eventLag']).length;
					t < o;
					t++
				)
			...
			(s.go = function () {
				...
				return (
					...
					(f = L(function (t, n) {
						g.progress;
						for (
							var i, o, r, a, l, u, p, h, f, d, y = (u = 0), v = !0, b = (p = 0), x = P.length;
							p < x;
							b = ++p
						)
							for (
	...
	(function (e, t) {
		...
		var l = {
					...
					(c =
						...
						(c =
							'touches' in e && e.touches.length
								? ((r = e.touches[0].pageY - o.top), e.touches[0].pageX - o.left)
				...
				hide: function (e, t) {
					for (
						var n = (t = t || this).getElementsByClassName('waves-rippling'), o = 0, r = n.length;
						o < r;
						o++
					)
						u(e, t, n[o]);
			...
			c = {
				...
				img: function (e) {
					var t,
						n = e.parentNode;
					('i' === n.tagName.toLowerCase() && n.classList.contains('waves-effect')) ||
						((t = document.createElement('i')), n.replaceChild(t, e), t.appendChild(e));
				},
			};
		function u(e, t, n) {
			var i, o, r, s, c, u;
		...
		return (
			...
			(e.attach = function (e, t) {
				...
				for (var s = 0, a = e.length; s < a; s++)
					(o = (i = e[s]).tagName.toLowerCase()),
						-1 !== ['input', 'img'].indexOf(o) && (c[o](i), (i = i.parentElement)),
			...
			(e.calm = function (e) {
				for (var t = { type: 'mouseup', button: 1 }, n = 0, i = (e = r(e)).length; n < i; n++)
					l.hide(t, e[n]);
			}),
					...
					r(e, [
						...
						},
						{
							...
							value: function (t) {
								return new e(
									this.logger,
									n({}, { prefix: ''.concat(this.prefix, ':').concat(t, ':') }, this.options),
								);
							},
						},
					]),
						...
						},
						{
							...
							value: function (e, t, i, o, r) {
								var s =
									...
									a = [e, t];
								e.indexOf('.') > -1 && ((o = i), (i = t), (t = (a = e.split('.'))[1])),
									this.addNamespaces(t);
								var l = v(this.data, a) || {};
								o
									? (function e(t, n, i) {
									...
									if (s) {
										...
										for (var E in g)
											if (Object.prototype.hasOwnProperty.call(g, E)) {
												...
												(_[E] = this.translate(T, n({}, i, { joinArrays: !1, ns: c }))),
													_[E] === T && (_[E] = g[E]);
											}
										g = _;
									}
									...
									if (C || S || O) {
										...
										if ('fallback' === this.options.saveMissingTo && j && j[0])
											...
											'all' === this.options.saveMissingTo
												? (M = this.languageUtils.toResolveHierarchy(i.lng || this.language))
										...
										var D = function (e, t) {
											r.options.missingKeyHandler
												...
												: r.backendConnector &&
												  ...
												  r.backendConnector.saveMissing(e, u, t, O ? i.defaultValue : g, O, i),
						...
						},
						{
							...
							value: function (e, t, i, o, r) {
								...
								if (this.i18nFormat && this.i18nFormat.parse)
									e = this.i18nFormat.parse(e, i, o.usedLng, o.usedNS, o.usedKey, { resolved: o });
									...
									if (
										(this.options.interpolation.defaultVariables &&
											(u = n({}, this.options.interpolation.defaultVariables, u)),
									...
									e.forEach(function (e) {
										if (!s.isValidLookup(t)) {
											...
											var p = void 0 !== a.count && 'string' != typeof a.count,
												h =
													void 0 !== a.context && 'string' == typeof a.context && '' !== a.context,
												f = a.lngs
													? a.lngs
													: s.languageUtils.toResolveHierarchy(a.lng || s.language, a.fallbackLng);
													...
													!S[''.concat(f[0], '-').concat(e)] &&
														...
														s.logger.warn(
															'key "'
																...
																.concat(f.join(', '), '" won\'t get resolved as namespace "')
							...
							value: function (e, t) {
								...
								for (
									...
									'string' != typeof o && (o = g(o)),
										o ||
											(this.logger.warn(
												'missed to resolve '.concat(i[1], ' for nesting ').concat(e),
											),
											(o = '')),
										u &&
					...
					r(t, [
						{
							...
							value: function (e, t, n, i) {
								...
								return (
									...
									(r.length || s.length) &&
										this.queue.push({ pending: s, loaded: {}, errors: [], callback: i }),
								...
								this.read(o, r, 'read', void 0, void 0, function (i, s) {
									i &&
										...
										!i &&
											s &&
											t.logger.log(
												''.concat(n, 'loaded namespace ').concat(r, ' for language ').concat(o),
												s,
											),
										t.loaded(e, i, s);
								});
							...
							value: function (e, t, i, o, r) {
								...
								!this.services.utils.hasLoadedNamespace(t)
									...
									: null != i &&
									  ...
									  (this.backend &&
											this.backend.create &&
											this.backend.create(e, t, i, o, null, n({}, s, { isUpdate: r })),
				...
				r(o, [
					{
						...
						value: function () {
							...
							return (
								this.options.resources || !this.options.initImmediate ? c() : setTimeout(c, 0), l
							);
						},
					},
					{
	...
	(function (e, t) {
		...
		function l(e, t, n, i, o) {
			i && 'object' === s(i) && (o || (i._t = new Date()), (i = a('', i).slice(1))),
				t.queryStringParams && (e = a(e, t.queryStringParams));
			try {
				var r;
				(r = XMLHttpRequest ? new XMLHttpRequest() : new ActiveXObject('MSXML2.XMLHTTP.3.0')).open(
					i ? 'POST' : 'GET',
					e,
					1,
				),
				...
				cacheUserLanguage: function (e, t) {
					t.lookupCookie &&
						...
						(function (e, t, n, i) {
							...
							n &&
								((o.expires = new Date()), o.expires.setTime(o.expires.getTime() + 60 * n * 1e3)),
								i && (o.domain = i),
			...
			init: function (n, i) {
				function o(t, i, o) {
					...
					if (0 !== i.length) {
						...
						if ((i.indexOf(';') === i.length - 1 && (i = i.substr(0, i.length - 2)), 'html' === s))
  ...
  */ !(function () {
			...
			function (e, t, n) {
				...
				var i,
					...
					h = !1;
				[].keys &&
					('next' in (r = [].keys()) ? (o = s(s(r))) !== Object.prototype && (i = o) : (h = !0)),
					null == i && (i = {}),
					u ||
						l(i, p) ||
						a(i, p, function () {
			...
			function (e, t, n) {
				...
				e.exports = function (e) {
					var t,
						...
						v = c(h);
					if (
						(m && (g = i(g, d > 2 ? arguments[2] : void 0, 2)), null == v || (f == Array && s(v)))
					)
			...
			function (e, t, n) {
				...
				(e.exports =
					...
					function (e, t) {
						...
						return (
							null !== e
								? ((u.prototype = i(e)), (n = new u()), (u.prototype = null), (n[c] = e))
								: (n = p()),
							void 0 === t ? n : o(n, t)
						);
					}),
				...
				e.exports = function (e, t, n, u, f, v, b) {
					...
					if (
						(O &&
							...
							d !== Object.prototype &&
								x.next &&
								(p || r(x) === d || (s ? s(x, d) : 'function' != typeof x[m] && l(x, m, y)),
								a(x, E, !0, !0),
								p && (h[E] = y))),
						'values' == f &&
							C &&
						...
						if (((w = { values: k('values'), keys: v ? A : k('keys'), entries: k('entries') }), b))
			...
			function (e, t, n) {
				...
				r(
					...
					function () {
						...
						return o >= n.length
							? { value: void 0, done: !0 }
							: ((e = i(n, o, !0)), (t.index += e.length), { value: e, done: !1 });
					},
				);
			},
			function (e, t, n) {
								...
								? ('' !==
												...
												: (function () {
														...
														g.hasClass('input-sm') && (n = 'input-group-sm'),
															...
															g.hasClass('input-sm')
																...
																: g.hasClass('input-lg') && l.addClass('input-group-lg');
												  })();
								  })(),
								  (c = {
								  ...
								  g.on('keydown.touchspin', function (e) {
										...
										38 === t
											...
											: 40 === t && ('down' !== v && (E(), T()), e.preventDefault());
								  }),
								  ...
								  c.down.on('mousedown.touchspin', function (e) {
										c.down.off('touchstart.touchspin'),
											g.is(':disabled') || (E(), T(), e.preventDefault(), e.stopPropagation());
								  }),
								  ...
								  c.up.on('mousedown.touchspin', function (e) {
										c.up.off('touchstart.touchspin'),
											g.is(':disabled') || (k(), S(), e.preventDefault(), e.stopPropagation());
								  }),
								  ...
								  g.on('touchspin.updatesettings', function (t, n) {
										!(function (t) {
											(function (t) {
												(r = e.extend({}, r, t)),
													t.postfix &&
														(0 === g.parent().find('.bootstrap-touchspin-postfix').length &&
															a.insertAfter(g),
														g
															.parent()
															...
															.text(t.postfix)),
													t.prefix &&
														(0 === g.parent().find('.bootstrap-touchspin-prefix').length &&
															s.insertBefore(g),
														g
															.parent()
											...
											var n = c.input.val();
											'' !== n &&
												((n = Number(r.callback_before_calculation(c.input.val()))),
